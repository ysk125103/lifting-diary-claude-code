...
export default function EditWorkoutForm({
  ...
  const [startedAt, setStartedAt] = useState(toLocalDatetimeValue(defaultStartedAt))
  const [duration, setDuration] = useState<string>('')
  const [customEnd, setCustomEnd] = useState<string | null>(
    toLocalDatetimeValue(defaultFinishedAt),
  )

  const computedFinishedAt =
    customEnd ?? toLocalDatetimeValue(addMinutes(new Date(startedAt), Number(duration)))
